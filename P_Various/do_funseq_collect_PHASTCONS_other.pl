...
#21/1/2015 
#I want to collect all phascons scores for all variants in VDR_JASPAR motifs (or subset of theses)
#Then, I want to plot a boxplot for each of the motif positions with the phastcons scores
#label phastcons scores for variants which break the motif

#this is different from the file do_funseq_phastcons_motif_sequences.pl. That one collects ALL scores in intervals of 15 for all VDR:RXR motifs 

#Output is as follows:
#type	position	phastcons_score
#break
...
if(!$infile){
	print "USAGE: do_funseq_collect_PHASTCONS.pl -i=<INFILE> -subset=<SUBSET_BED> -sym -enh\n";
