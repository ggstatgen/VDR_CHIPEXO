...
my $infile_ph_data = '/net/isi-scratch/giuseppe/indexes/GWAS/gwascatalog_20150127_hg38.txt';
...
#uncomment this if you are sure you use gwas in hg19 format
