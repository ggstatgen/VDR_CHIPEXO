...
#2015/11/26
#I want to get the list of CHIPSEQ VDR-rBVs
#I modify the other one slighly to deal with the CHIPSEQ samples
...
my $INPUT_ALLELESEQ_RAW = "/net/isi-scratch/giuseppe/VDR/ALLELESEQ/VDR_CHIPSEQ/PIPELINE_SANDBOX_CHIPSEQ/RESULTS_CPo3/interestingHets_vdrchipseq.txt";
...
#not sure whether these are suitable
...
#############
#1.0 If ASB p-value thresholding is required, build a map of acceptable VDR-ASB to follow up in the next steps
#############
if($PVAL_THRS){
