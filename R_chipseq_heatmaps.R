#Giuseppe 15/10
#found this here 
#http://crazyhottommy.blogspot.co.uk/2013/08/how-to-make-heatmap-based-on-chip-seq.html
#I want to use it in a pipeline after Homer
#I can do the stuff in here with cluster + tree view, but can't parallelise it and run it on the cluster
...
m.row.sum<- cbind(m1, rowSums(m1)) #save sum of values in last column
o1<- rev(order(m.row.sum[,ncol()]))
