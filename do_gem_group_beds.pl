...
#17-4-2013
#This is used to pick all the *_2_GEM_events.bed from the _outputs directory produced by GPS and move them all in a single d_beds directory
#GM06986_2_GEM_events.bed
